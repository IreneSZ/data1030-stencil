...
def check_birthday_spacings(seq, n):
    ...
    COUNT_TOLERANCE = 0.4
    return COUNT_TOLERANCE * number_of_subarrays <= \
...
# Get the mth combination in lexicographical order from A (n elements)
# chosen k at a time.
...
# Run func several times, and early return if it succeeds; otherwise,
# throws TestFailure.
